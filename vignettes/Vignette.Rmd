...
The default number of latent variables is 2.
```{r}
...
```{r}
res3 <- newWave(data,X = "~Batch", verbose = T,K=2, children=2, n_gene_disp=100,  n_gene_par = 100, n_cell_par = 100, commondispersion = FALSE)
```
