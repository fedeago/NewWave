...
```{r}
res2 <- newWave(data,X = "~Batch", K=10, verbose = T, children=10)
```

Or use some mini-batch approaches:

```{r}
res3 <- newWave(data,X = "~Batch", verbose = T,K=10, children=10, n_gene_disp=100,  n_gene_par = 100, n_cell_par = 100, commondispersion = F)
```
